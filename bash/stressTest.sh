...
# Lancement des trois machines de stress test
echo "Démarrage du machine 1..."
java -cp ./bin jvn.test.StressTest &

# Lancement des trois machines IRC
echo "Démarrage du machine 2..."
java -cp ./bin jvn.test.StressTest &

# Lancement des trois machines IRC
echo "Démarrage du machine 3..."
java -cp ./bin jvn.test.StressTest &
